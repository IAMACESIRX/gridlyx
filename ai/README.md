...
Do not ingest [`vault/`](../vault/), binaries, build outputs or every generated workspace unless the task specifically needs them. AI context files are navigation aids; implementation and validation evidence remain authoritative.
